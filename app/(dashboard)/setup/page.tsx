    ...
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        <form action={saveProfile} className="card flex flex-col gap-3 md:flex-row md:items-end">
          <div className="flex-1 space-y-1"><label>What is your name?</label><input name="name" defaultValue={profile.data?.name ?? ""} required /></div>
      ...
      <section className="space-y-3"><h2 className="text-xl font-semibold">Step 4: Emergency Savings</h2><EmergencyForm settings={emergency.data} /></section>
